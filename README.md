...
This repository documents my daily progress as I build hands-on skills in data analysis using tools like Power BI, Tableau, Jupyter (Python), SQLite, and DBeaver. Each day includes a brief summary of what I accomplished, with files organized by tool in subfolders.
